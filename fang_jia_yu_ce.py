...
num_hiddens1, num_hiddens2, num_hiddens3, dropout1, dropout2, dropout3 = 256, 128, 64, 0.1, 0.2, 0.1
def get_net():
    net = nn.Sequential(nn.Linear(in_features, num_hiddens1),
                        nn.ReLU(),
...
k, num_epochs, lr, weight_decay, batch_size =15, 100, 0.08, 50, 256
